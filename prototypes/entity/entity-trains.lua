data:extend({
  {
    ...
    inventory_size = 60,
    minable = {mining_time = 0.5, result = "cargo-wagon-mk2"},
  ...
  },
  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    inventory_size = 100,
    minable = {mining_time = 0.5, result = "cargo-wagon-mk3"},
    mined_sound = {filename = "__core__/sound/deconstruct-medium.ogg"},
    max_health = 1800,
    corpse = "medium-remnants",
    dying_explosion = "medium-explosion",
  ...
  --Locomotive
  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "locomotive-mk2"},
    mined_sound = {filename = "__core__/sound/deconstruct-medium.ogg"},
    max_health = 2000,
    corpse = "medium-remnants",
    dying_explosion = "medium-explosion",
  ...
  },
  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "locomotive-mk3"},
    mined_sound = {filename = "__core__/sound/deconstruct-medium.ogg"},
    max_health = 3000,
    corpse = "medium-remnants",
    dying_explosion = "medium-explosion",
  ...
  --Fluid Wagon
  {
    ...
    icon_size = 32,
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "fluid-wagon-mk2"},
    mined_sound = {filename = "__core__/sound/deconstruct-medium.ogg"},
    max_health = 1200,
    capacity = 75000,
    corpse = "medium-remnants",
  ...
  },
  {
    ...
    icon_size = 32,
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "fluid-wagon-mk3"},
    mined_sound = {filename = "__core__/sound/deconstruct-medium.ogg"},
    max_health = 1800,
    capacity = 175000,
    corpse = "medium-remnants",
